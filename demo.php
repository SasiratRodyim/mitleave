...
<div class="position-relative overflow-hidden p-3 p-md-5 m-md-3 text-center bg-light ">
  <div class="col-md-5 p-lg-5 mx-auto my-5">
    <h1 class="display-4 font-weight-normal">LEAVE MANAGEMENT SYSTEM</h1>
    <p class="lead font-weight-normal">โปรแกรมสำหรับการลาออนไลน์ ของนิสิตและบุคลากร คณะวิศวกรรมคอมพิวเตอร์ ภาควิชาคอมพิวเตอร์และอิเล็กทรอนิกส์</p>
