...
<div class="position-relative overflow-hidden p-3 p-md-5 m-md-3 text-center bg-light ">
  ...
  <h1 class="display-3 font-weight-normal">Welcome :)</h1>
    <p class="lead font-weight-normal">สถานะ : <font color="green"> Teacher </font> </p>
    <a class="py-2 d-none d-md-inline-block" href="allow.php" name="allow">Allow</a>
    <?php

      $query = "SELECT * FROM leavee username WHERE username = 'p'";
    ...
    <a class="py-2 d-none d-md-inline-block" href="leave2.php">Leave</a>
  </div>
