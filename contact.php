...
<meta name="theme-color" content="#563d7c">
  ...
  <div class="container d-flex flex-column flex-md-row justify-content-between">
    ...
    <a class="py-2 d-none d-md-inline-block" href ="demo.php" ><img src= home2.png width=40 height=40></a>
    
    <a class="py-2 d-none d-md-inline-block" href="howto.php">How to use?</a>
    <a class="py-2 d-none d-md-inline-block" href="contact.php">Contact Us</a>
    <a class="py-2 d-none d-md-inline-block" href="register.php"><button type="submit" class="btn btn-info" id="btn" name="btnSubmit">
...
<div class="d-md-flex flex-md-equal w-100 my-md-3 pl-md-3 ">
  <div class="border border-dark bg-dark mr-md-3 pt-3 px-3 pt-md-5 px-md-5 text-center text-white overflow-hidden">
    <div class="my-3 py-3 ">
      <h2 class="display-5 font-weight-normal">Contact US</h2>
      <img src= "1.png" width=150 height=150>
      <center>
        Email : Gunzaa@hotmail.com</center>
      <center>
        Call : 0888941443</center>
      <center>
        Line ID : nugun</center>
      <center>  
        FB : </center>
    
      <img src= "2.png" width=150 height=150>
      <center>
        Email : Chabeam@hotmail.com</center>
      <center>
        Call : 0922677759</center>
      <center>
        Line ID : .beammmm</center>
      <center>  
        FB : Chalisa Jitsilpchayakul</center>
      <img src= "3.png" width=150 height=150>
      <center>
        Email : Icetiamak@hotmail.com</center>
      <center>
        Call : 0873316780</center>
      <center>
        Line ID : nuice</center>
      <center>  
        FB : Nongnapat Ice</center>
      <img src= "4.png" width=150 height=150>
      <center>
        Email : kaekaee.1410@gmail.com</center>
      <center>
        Call : 0868096699</center>
      <center>
        Line ID : kaekaee1999</center>
      <center>  
        FB : Nutnicha Phasuk</center>
      <img src= "5.png" width=150 height=150>
      <center>
        Email : Framezaamak@hotmail.com</center>
      <center>
        Call : 0990980110</center>
      <center>
        Line ID : nuframe</center>
      <center>  
        FB : Sasirat Romyim</center>
      
    </div>
<br>
    <div class="bg-light shadow-sm mx-auto" style="width: 80%; height: 400px; border-radius: 21px 21px 0 0;">
    <ul class="list-unstyled text-small text-center ">
    <small><font color="black"><br><br><p class="lead font-weight-normal">เว็บไซต์ : http://www.cpe.eng.kps.ku.ac.th  Facebook : ภาควิชาวิศวกรรมคอมพิวเตอร์ กพส. Fanpage Facebook : ภาควิชาวิศวกรรมคอมพิวเตอร์ กำแพงแสน</p>
    <img src= "cpe-p.jpg" width=500 height=250>
    </div></font></small>
