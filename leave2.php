<?php
      ...
      if (isset($_POST['enter'])) {
          ...
          $username = $_SESSION['username'];
            ...
            $query = "INSERT INTO leavee (type,detail,start,deadline,file,username)
                        VALUE ('$type','$detail','$start','$deadline','$file','$username')";
...
<?php 
if(isset($teacher)){
  echo '<input type="text" value="'.$teacher.'"><a href="teacher.php" target="self"><button type="button" class="btn btn-secondary" data-dismiss="modal">เลือกรายชื่อ</button></a>';
}
else{
  echo '<input type="text"> <a href="teacher.php" target="self"><button type="button" class="btn btn-secondary" data-dismiss="modal">เลือกรายชื่อ</button></a>';
}
?>
